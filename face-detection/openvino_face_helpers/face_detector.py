...
from openvino_face_helpers.ie_module import Module
from openvino_face_helpers.utils import resize_input
...
class FaceDetector(Module):
    ...
    def __init__(
        self, core, model, input_size, confidence_threshold=0.5, roi_scale_factor=1.15
    ):
        ...
        if input_size[0] > 0 and input_size[1] > 0:
            ...
            raise ValueError(
                "Both input height and width should be positive for Face Detector reshape"
            )
        ...
        if (
            ...
            raise RuntimeError(
                "The model expects output shape with {} outputs".format(
